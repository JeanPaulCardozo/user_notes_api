...
def create_note(db: Session, note_schema: NoteCreate) -> Notes:
    new_note = Notes(title=note_schema.title, content=note_schema.content)
...
def get_notes(db: Session) -> list[Notes]:
